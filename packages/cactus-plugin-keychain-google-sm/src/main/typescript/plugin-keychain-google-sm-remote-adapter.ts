...
export interface IPluginKeychainGoogleSmRemoteAdapterOptions
 ...
 */
export class PluginKeychainGoogleSmRemoteAdapter
  implements ICactusPlugin, IPluginWebService {
  public static readonly CLASS_NAME = "PluginKeychainGoogleSmRemoteAdapter";
  ...
  public get className(): string {
    return PluginKeychainGoogleSmRemoteAdapter.CLASS_NAME;
  }

  constructor(
    public readonly opts: IPluginKeychainGoogleSmRemoteAdapterOptions,
  ) {
  ...
  public async delete(key: string): Promise<void> {
    // FIXME Pretty sure google secretmanager can do delete so we don't have to hack it like this
